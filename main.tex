...
parameters (per-seed statistics in Supplementary Table~4). The hidden-coordination flagship uses 8 individually-observing
...
frozen detector (Supplementary Table~5). The neural replications keep both environments and
...
alongside the fine-grid result (Supplementary Table~6). The initialization sweep varies the
...
(per-seed conventions in Supplementary Table~7).
