...
and task success---through entirely different couplings (Extended
Data Fig.~1a),
...
Extended Data Fig.~1c)---contract-relativity made precise: ``higher-order'' is
...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth]{edfig1_instrument.pdf}
\caption{\textbf{Instrument validation on constructed ground truth.}
\textbf{a},~Four generators---central script, common cause, coincidence and
...
\textbf{c},~Source-decomposition ladder on analytic ground truth: each pure
