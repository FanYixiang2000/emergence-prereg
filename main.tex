...
removes the hidden phase (0.811 vs 0.884; Fig.~5c); both pooled
...
one: within every sticky seed the physical variable leads (0.946--0.956
vs 0.910--0.931; 0/5, a registered miss). We therefore do not claim
...
intervention times.
\textbf{c},~Matched-parameter contrast: in the pooled race, openness
ranks above the order parameter when a hidden consolidation phase
exists (sticky) and below it in the control; bars show pooled AUC
across five training seeds per condition. The sticky-arm ordering does
not persist at the seed level (registered miss; Methods).
