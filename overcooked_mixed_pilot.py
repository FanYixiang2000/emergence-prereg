...
PAIRS = {
    ...
    # Round-2 held-out candidates (neither layout used in round 1).
    "pair_D": ("coordination_ring", "counter_circuit"),
    "pair_E": ("coordination_ring", "bottleneck"),
    "pair_G": ("coordination_ring", "centre_pots"),
    "pair_H": ("coordination_ring", "large_room"),
    "pair_F": ("coordination_ring", "asymmetric_advantages"),
    "pair_I": ("asymmetric_advantages", "centre_pots"),
    "pair_J": ("cramped_room", "centre_pots"),
}
